    ...
    <div class="container paddding">
            ...
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">
                        Có n kết quả tìm kiếm
                    </div>
                </div>
                <?php foreach($data["newsByKeyword"] as $news) { ?>
                <div class="row pb-4">
                    <div class="col-md-5">
        ...
        <div class="row mx-0">
            <div class="col-12 text-center pb-4 pt-4">
                ...
                <a href="../news/search/<?php echo $keyword; ?>/<?php echo $data["thisPage"]-1; ?>" class="btn_mange_pagging"><i class="fa fa-long-arrow-left"></i>&nbsp;&nbsp; Previous</a>
                <?php 
                    $totalPage = $data["totalPage"];
                    for($currentPage = 1; $currentPage <= $totalPage; $currentPage++) { 
                ?>
                <a href="../news/search/<?php echo $keyword; ?>/<?php echo $currentPage; ?>" class="btn_pagging"><?php echo $currentPage; ?></a>
                <?php } ?>
                <a href="../news/search/<?php echo $keyword; ?>/<?php echo $data["thisPage"]+1; ?>" class="btn_mange_pagging">Next <i class="fa fa-long-arrow-right"></i>&nbsp;&nbsp; </a>
             </div>
        </div>
    </div>
</div>